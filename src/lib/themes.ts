...
export const templates: TemplateStyles = {
  classic: {
    ...
    preview: { background: "bg-gray-50", primary: "bg-gray-800", secondary: "bg-gray-200" },
    styles: {
      container: "bg-white text-gray-800",
      header: "border-b-2 border-gray-800 pb-4 mb-8 text-right",
      fromTo: "text-sm",
  ...
  bold: {
    ...
    styles: {
      container: "bg-gray-900 text-white p-10",
